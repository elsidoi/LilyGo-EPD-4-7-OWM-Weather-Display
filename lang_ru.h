...
const String TXT_CONDITIONS       = "Условия";
...
const String TXT_RAINFALL_IN = "Дождь (дйюм)";
const String TXT_SNOWFALL_MM = "Snowfall (мм)";
const String TXT_SNOWFALL_IN = "Snowfall (дйюм)";
...
//Wind
const String TXT_WIND_SPEED_DIRECTION = "Сила/Направление ветра";
